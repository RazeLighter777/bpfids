        ...
        Commands::Build => {
            ...
            match std::fs::File::create("bpfidsrules.c") {
                Ok(f) => {
                    ...
                    writeln!(w, "/* This file is autogenerated. Do not edit directly. */")
                        .expect("Failed to write to bpfidsrules.c");
        ...
        Commands::PrintTestRuleSerialization => {
            let test_rule = ids::IdsRule {
                ...
                expr: ids::IdsExpr::And(
                    ...
                    Box::new(ids::IdsExpr::Match(ids::IdsMatch::SourceHost(IpAddr::V4(
